...
exports.MCPStatusProvider = void 0;
const vscode = __importStar(require("vscode"));
class MCPStatusProvider {
    constructor(mcpAPI) {
        this.mcpAPI = mcpAPI;
        this.lastStatus = [];
    }
    async showStatusPanel() {
        ...
        this.statusPanel = vscode.window.createWebviewPanel('mcpStatus', 'MCP Platform Status', vscode.ViewColumn.One, {
            enableScripts: true,
...
exports.MCPStatusProvider = MCPStatusProvider;
//# sourceMappingURL=mcpStatusProvider.js.map